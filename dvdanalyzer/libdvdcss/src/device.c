...
static int win2k_open ( dvdcss_t dvdcss, const char *psz_device )
{
     ...
     * Pass Through Requests) */
     dvdcss->i_fd = (int) CreateFile(psz_dvd,					// lpFileName : pointer to name of the file
				GENERIC_READ | GENERIC_WRITE,		// dwDesiredAccess :access (read-write) mode
				FILE_SHARE_READ | FILE_SHARE_WRITE,	// dwShareMode : share mode
				NULL,								// lpSecurityAttributes,
				OPEN_EXISTING,						// dwCreationDisposition : how to create
				FILE_FLAG_SEQUENTIAL_SCAN,				// dwFlagsAndAttributes : file attributes
